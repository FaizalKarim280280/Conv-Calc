    ...
    return (
        ...
        <>
            ...
            <div className='p-4 mt-3'>
                <h2 className='display-6'>Conv 2D</h2>
                <Box
                    sx={{
                        display: 'flex',
                        flexWrap: 'wrap',
                    ...
                    <Link href="https://pytorch.org/docs/stable/generated/torch.nn.Conv2d.html" underline="hover" target='_blank_'>[PyTorch]</Link>

                    <Link href="https://www.tensorflow.org/api_docs/python/tf/keras/layers/Conv2D" underline="hover" target='_blank_'>[TensorFlow]</Link>
                </Box>
                ...
                <div style={{ "width": "20%" }}>
                    ...
                    <div className='d-flex align-items-center flex-column border border-primary rounded-4 mt-5'>
                        ...
                        <div className='d-flex flex-column p-3'>
                            ...
                            <TextField className='my-3' id="outlined-basic" label="Width" variant="outlined" size="small" type='number'
                                style={{ "width": "60%" }} name="width" value={outputShape['width']} disabled />
